...
import { of } from 'rxjs';
import { IGithubQuery } from 'src/app/Models/github-search.model';

describe('GridViewComponent', () => {
  let component: GridViewComponent;
  let fixture: ComponentFixture<GridViewComponent>;
  let serviceSpy: jasmine.SpyObj<GitgubSearchService>;

  beforeEach(async () => {
    const gitgubSearchServiceSpy = jasmine.createSpyObj('GitgubSearchService', ['getQuery', 'getSelectedView']);
    
    await TestBed.configureTestingModule({
      declarations: [ GridViewComponent ],
      providers: [{ provide: GitgubSearchService, useValue: gitgubSearchServiceSpy }]
    }).compileComponents();

    serviceSpy = TestBed.inject(GitgubSearchService) as jasmine.SpyObj<GitgubSearchService>;
    fixture = TestBed.createComponent(GridViewComponent);
    component = fixture.componentInstance;
});

  it('should create', () => {
    // serviceSpy.getSelectedView.and.returnValue(of(false));
    expect(component).toBeTruthy();
  });



  // it('should display data correctly in grid view', async () => {
  //   const mockData = {
  //     query: { MockResult }
  //   };
  //   serviceSpy.getQuery.and.returnValue(of(mockData));
  //   serviceSpy.getSelectedView.and.returnValue(of(true));
  //   fixture.detectChanges();
  //   //Need some time to fix this because of the async pipe used in template
  //   await fixture.whenStable();
  
  //   expect(fixture.nativeElement.querySelector('.grid-view-li')).toBeTruthy();
  //   expect(fixture.nativeElement.querySelector('.grid-view-li').textContent).toContain('Test Repo');
  //   expect(fixture.nativeElement.querySelector('.grid-view-li').textContent).toContain('Test Description');
  // });

  it('should switch to card view when selected view is changed', fakeAsync(() => {
    serviceSpy.getSelectedView.and.returnValue(of(false));
    fixture.detectChanges();
    tick();

    expect(component.isGridView).toBeFalse();
    expect(component.itemSize).toEqual(component.LG_SIZE_CARD); // when using big screen
  }));
...
export const TestResponse = {
  ...
  updated_at: "2024-04-08T10:00:39Z",
  pushed_at: "2024-04-07T15:34:45Z",
  ...
  size: 429455,
  stargazers_count: 221088,
  watchers_count: 221088,
  language: "JavaScript",
  has_issues: true,
  has_projects: true,
  has_downloads: true,
...
export const MockResult: IGithubQuery = {
